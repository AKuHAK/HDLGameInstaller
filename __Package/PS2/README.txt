2e Following package was recompiled by El_isra.

Only the background and the game launcher for the HDD-OSD have been changed.

Compiled with PS2Dev:v1.0 docker image, wich is the newest one that could be used without making structural changes to the SRC.

Sp193 is the creator of this program, all the credits go to him
