# Legacy MiniOPL (AKA: DISKLOAD)

#### The contents of this folder are the source code of MiniOPL.

#### MiniOPL was a extremely trimmed down program based on OpenPS2Loader 0.9.1

### This program became obsolete in 2021. it was superceded by [OPL-Launcher](https://github.com/ps2homebrew/OPL-Launcher), wich is superior in many aspects



The text after this line is the original Readme from the package:
```
-----------------------------------------------------------------------------
